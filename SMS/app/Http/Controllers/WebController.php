...
class WebController extends Controller
{
    ...
    public function detail($id)
    {
        ...
        return view('website.course.detail', ['subject' => $this->subject,'check' => $this->checkEnroll]);
    }
    public function enroll($id)
    {
        if (Session::get('student_id'))
        {
            ...
            return redirect('/student-dashboard')->with('message', 'New Course Added Successfully');
        }
        else
        {
